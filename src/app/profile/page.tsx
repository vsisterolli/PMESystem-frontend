...
export default function Profile({ searchParams }) {
        ...
        client
            ...
            .catch((e) => {
                ...
                if (e.response.status === 401) {
                    toast.error(
                        "Opa! Você precisa logar antes de acessar essa página."
                    );
                    clearContext();
                }
    ...
    const renderedComponent = {
        ...
        notFound: (
            <Suspense>
                <NotFound nick={nick} options={options} />
            </Suspense>
        )
    };
    ...
    return (
        <>
            ...
            <main
                className={
                    "flex flex-col items-center md:items-start md:flex-row  flex-center min-w-screen min-h-screen " +
                    styles.profile
                }
            >
