  ...
  return (
    <main className={"min-h-screen min-w-screen " + styles.home}>
      ...
      <div className={styles.newMilitary}>
        <Tippy content="realgabri169!" placement="bottom">
          <div className={styles.newPolice}>
            <Image width={150} height={222}
                   src={`https://www.habbo.com.br/habbo-imaging/avatarimage?img_format=png&user=${"realgabri169"}&direction=3&head_direction=3&size=l&gesture=sml&action=std`}
