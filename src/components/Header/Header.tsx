...
export default function Header({ menuState }) {
    ...
    return (
        <>
            ...
            <header
                className={
                    "fixed w-screen bg-sky-500/0 flex md:justify-center items-center " +
                    styles.hd
                }
            >
                <div>
                    <a href="/home">
                        <h1
                            className={
                                styles.titleMain + " " + leagueGothic.className
                            }
                        >
                            SYSTEM
                        </h1>
                        <h1
                            className={styles.titleSub + " " + alatsi.className}
                        >
                            PME
                        </h1>
                    </a>
                ...
                <form onSubmit={searchUser}>
                    <div className={"flex " + styles.searchInput}>
                        ...
                        <input
                            ...
                            className={styles.findUser + " " + alata.className}
                        />
                    </div>
                </form>
